...
void main() {
  ...
  vec2 uv = snappedFragCoord / resolution.xy;
  uv -= 0.5;
  ...
  int bx = int(mod(ditherCoord.x, 8.0));
  int by = int(mod(ditherCoord.y, 8.0));
...
interface WaveUniforms {
  ...
  bayer: THREE.Uniform<Float32Array>;
}
